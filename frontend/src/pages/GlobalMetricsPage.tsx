...
// Previously a CalendarIcon when the UI said "Day". Now a step
// indicator (two stacked right-chevrons with a baseline) to match
// the "Step X of Y" semantics — Prophet's simulation loop ticks
// in discrete steps, not real-world days.
function StepIcon() { return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="4 6 10 12 4 18" /><polyline points="12 6 18 12 12 18" /><line x1="3" y1="22" x2="21" y2="22" /></svg>; }
