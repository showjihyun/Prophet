    ...
    >
      ...
      <div className="w-[360px] shrink-0 border-r border-[var(--border)] p-3 flex flex-col gap-2">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] font-medium px-1.5 py-0.5 rounded bg-yellow-100 text-yellow-700 animate-pulse-dot">
            Analyzing
          </span>
        </div>
        <div className="flex-1 text-[12px] leading-relaxed text-[var(--muted-foreground)] bg-[var(--secondary)] rounded-md p-2.5 overflow-y-auto">
          Community Alpha shows accelerating adoption with 62% positive
          sentiment. Bridge agents (BR-0012, BR-0034) are critical for
          cross-community propagation. Cascade #47 has reached depth 12,
          indicating strong viral potential. Recommend increasing stimulus
          in Gamma community where skepticism remains at 25%.
        </div>
      </div>
